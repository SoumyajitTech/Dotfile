...
char phone_no[] = "+918637813772"; //replace with phone no. to get sms
...
void setup()
{
  ...
  Serial.print("AT+CNMI=2,2,0,0,0r");
  delay(100);
 pinMode(6,INPUT);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if(textMessage.indexOf("LOCAL")>=0){
    ...
    Gsm.println(""");
     ...
     lcd.print("To Base....");
     delay(3000);
    Gsm.println("Name of the Patient ");
  ...
  if(state==1)     //If newData is true
  {
    ...
    Gsm.println(""");
     ...
     lcd.print("To Base....");
     delay(3000);
    Gsm.println("Alert I need help...."Name of the Patient"");
     Gsm.print("Temperature is  ");
      Gsm.println(tempc);
       Gsm.print("Heartbeat is  ");
      Gsm.println(ldrStatus/10);
